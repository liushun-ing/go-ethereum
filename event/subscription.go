...
// 将s.unsub 通道交给producer去执行，执行完后，执行完了之后，就需要将其设置为取消订阅状态
// 通常，这个producer函数，就是读取他的参数channel，也就是等待别人朝这个channel写东西，写了就结束，类似于别人取消订阅了
// 所以这个producer中监测到别人终止了，他也就会将当前的 funcSub 给设置为取消订阅
