...
type TypeMuxSubscription struct {
	...
	// Chan.
	postMu sync.RWMutex
	readC  <-chan *TypeMuxEvent // 读通道，接受事件
	postC  chan<- *TypeMuxEvent // 写通道，用于发布事件
}
